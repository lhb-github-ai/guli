...
<el-form-item label="课程简介">
  ...
  <el-form-item>
    <el-button :disabled="saveBtnDisabled" type="primary" @click="SaveOrUpdate"  v-if="logo!='5'">保存并下一步</el-button>
    <el-button type="primary"  v-if="logo==='5'" @click="update1111">提交</el-button>
  </el-form-item>
</el-form>
  </div>
</template>
